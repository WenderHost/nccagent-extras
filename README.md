...
### 4.6.1 ###
* Dequeuing `global.js` as it only contains deprecated/unused JavaScript.
* Disabling `enqueue_cleanup()`. Restores "X" icon in social media icons widget.

### 4.6.0 ###
* Adding Elementor Cloudflare Turnstile integration.
