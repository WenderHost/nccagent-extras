...
function add_dashboard_link( $items, $args ){
  ...
  if( 'top-bar' == $args->menu ){
    if( is_user_logged_in() ){
      $items .= '<li class="' . $item_classes . '"><a class="elementor-item" href="' . home_url( 'dashboard' ) . '/">My Dashboard/Log Out</a></li>';
    } else {
      $items .= '<li class="' . $item_classes . '"><a class="elementor-item" href="' . home_url( 'login-register' ) . '/">Log In or Register</a></li>';
    }
  }
  return $items;
}
