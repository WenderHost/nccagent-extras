...
function product_page(){
  ...
  if( ! empty( $productcarrier ) ){
    ...
    $html[] = '<div style="margin-bottom: 2em;"><h2>Explore ' . get_the_title( $product->ID ) . ' Products from these Carriers</h2>' . \NCCAgent\shortcodes\acf_get_product_carriers([ 'post_id' => $product->ID ] ) . '</div>';
  }
  return implode( '', $html );
}
