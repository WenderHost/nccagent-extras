...
function ncc_product_by_state_selector(){
  ...
  wp_localize_script( 'select2', 'wpvars', ['product' => get_the_title( $product->ID ), 'product_finder_url' => $product_finder_url, 'product_finder_slug' => str_replace([home_url(),'/'], ['',''], $product_finder_url ), 'stateOptionData' => $selector['data'] ] );
