...
function enqueue_scripts(){
  ...
  wp_register_script( 'datatables-init', plugin_dir_url( __FILE__ ) . '../js/plan-finder.js', ['datatables','choices'], filemtime( plugin_dir_path( __FILE__ ). '../js/plan-finder.js' ), true );
