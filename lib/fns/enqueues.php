...
function enqueue_scripts(){
  // DATATABLES: Datatables provides the app framework which powers the Plan Finder
  ...
  // SELECT2: We use Select2 for enhanced selects on the Plan Finder
  wp_register_script( 'select2', 'https://cdn.jsdelivr.net/npm/select2@4.0.12/dist/js/select2.min.js', ['jquery'], '4.0.12' );

  // PLAN FINDER: My custom JS which initializes the Plan Finder
