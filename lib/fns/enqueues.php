...
function enqueue_scripts(){
  ...
  wp_enqueue_style( 'nccagent-styles', plugin_dir_url( __FILE__ ) . '../' . $css_dir . '/main.css', ['google-fonts','hello-elementor','elementor-frontend'], plugin_dir_path( __FILE__ ) . '../' . $css_dir . '/main.css' );
}
