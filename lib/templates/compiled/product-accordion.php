...
'.LR::sec($cx, (($inary && isset($in['products'])) ? $in['products'] : null), null, $in, true, function($cx, $in) {$inary=is_array($in);return '  <div class="accordion-toggle" id="'.htmlspecialchars((string)(($inary && isset($in['toggle_id'])) ? $in['toggle_id'] : null), ENT_QUOTES, 'UTF-8').'">
    <span>'.htmlspecialchars((string)(($inary && isset($in['title'])) ? $in['title'] : null), ENT_QUOTES, 'UTF-8').'</span><i class="fas fa-chevron-down"></i>
  </div>
  <div class="accordion-content" id="'.htmlspecialchars((string)(($inary && isset($in['toggle_id'])) ? $in['toggle_id'] : null), ENT_QUOTES, 'UTF-8').'-content">
    ...
    '.((LR::ifvar($cx, (($inary && isset($in['states_review_date'])) ? $in['states_review_date'] : null), false)) ? '<p class="review-date">Current as of '.htmlspecialchars((string)(($inary && isset($in['states_review_date'])) ? $in['states_review_date'] : null), ENT_QUOTES, 'UTF-8').''.((LR::ifvar($cx, (($inary && isset($in['plan_year'])) ? $in['plan_year'] : null), false)) ? ' &ndash; <span class="plan-year">Plan Year '.htmlspecialchars((string)(($inary && isset($in['plan_year'])) ? $in['plan_year'] : null), ENT_QUOTES, 'UTF-8').'</span>' : '').'</p>' : '').'
    <p>'.(($inary && isset($in['states'])) ? $in['states'] : null).'</p>
    <h3>Plan Information</h3>
    '.((LR::ifvar($cx, (($inary && isset($in['desc_review_date'])) ? $in['desc_review_date'] : null), false)) ? '<p class="review-date">Current as of '.htmlspecialchars((string)(($inary && isset($in['desc_review_date'])) ? $in['desc_review_date'] : null), ENT_QUOTES, 'UTF-8').''.((LR::ifvar($cx, (($inary && isset($in['plan_year'])) ? $in['plan_year'] : null), false)) ? ' &ndash; <span class="plan-year">Plan Year '.htmlspecialchars((string)(($inary && isset($in['plan_year'])) ? $in['plan_year'] : null), ENT_QUOTES, 'UTF-8').'</span>' : '').'</p>' : '').'
