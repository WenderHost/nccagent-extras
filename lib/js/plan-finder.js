...
(function($){
  ...
  const dtOptions = {
    ...
    columns: [
      ...
      {
        data: function(d){
          return `<a href="#" class="details-link"></a><div class="content"><h4 class="row-title"><a href="${d.product.url}" target="_blank">${d.carrier.name} ${d.product.alt_name}</a></h4><div class="states">${d.states}</div></div>`;
        },
        orderable: false
      }
    ],
